...
public class Devoir2
{
    ...
    private static void initialiseStatements() throws SQLException
    {
        ...
        stmtInsertJury = cx.getConnection().prepareStatement(
                "insert into \"Jury\" (nas, prenom, nom, sexe, age) " + "values (?,?,?,?,?)");
        ...
        stmtSelectJuges = cx.getConnection().prepareStatement("select * from \"Juge\"");
        ...
        stmtJugeRetirer = cx.getConnection().prepareStatement("delete from \"Juge\" where \"Juge_id\" = ?");
        ...
        stmtTerminerProcesSeance = cx.getConnection().prepareStatement("delete from \"Seance\" where \"id\" = ?");
    }
...
>>>>>>> parent of 2026e33... Update correctif
